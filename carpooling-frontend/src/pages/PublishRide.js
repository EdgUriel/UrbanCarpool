...
const MapComponent = ({ origin, destination }) => (
  <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
    <p className="text-gray-600">Map showing route from {origin} to {destination}</p>
  </div>
);
    ...
    <div className="bg-gradient-to-br from-blue-50 to-blue-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
        <div className="bg-blue-600 py-6 px-8">
          ...
          <p className="text-blue-100 mt-2">Share your journey and help build a greener community</p>
        </div>
        ...
        {formData.origin && formData.destination && (
          <div className="px-8 pb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Route Preview</h2>
            <MapComponent origin={formData.origin} destination={formData.destination} />
          </div>
        )}
      </div>
    </div>
